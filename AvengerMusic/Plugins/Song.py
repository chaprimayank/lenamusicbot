...
from AvengerMusic.Inline import song_download_markup, song_markup
from AvengerMusic.Utilities.url import get_url
from AvengerMusic.Utilities.youtube import get_yt_info_query, get_yt_info_query_slider
...
@app.on_message(
    filters.command(["video", f"video@{BOT_USERNAME}"]) & filters.group
)
@PermissionCheck
